...
export const vi: TranslationMap = {
  ...
  agents: {
    ...
    overview: {
      ...
      noProviders: "Chưa có nhà cung cấp API nào. Thêm provider để chọn model.",
      addApiProvider: "Thêm API Provider",
      addApiProviderSub: "Nhập API key để kích hoạt các model từ nhà cung cấp này.",
      addApiProviderConfirm: "Thêm Provider",
