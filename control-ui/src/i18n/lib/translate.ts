...
class I18nManager {
  ...
  public async setLocale(locale: Locale) {
    const needsTranslationLoad = isLazyLocale(locale) && !this.translations[locale];
  ...
  public t(key: string, params?: Record<string, string>): string {
    ...
    let value: unknown = this.translations[this.locale] ?? this.translations[FALLBACK_LOCALE];
    ...
    if (value === undefined && this.locale !== FALLBACK_LOCALE) {
