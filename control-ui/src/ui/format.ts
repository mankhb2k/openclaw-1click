import { formatDurationHuman } from "@openclaw/infra/format-time/format-duration.ts";
import { formatRelativeTimestamp } from "@openclaw/infra/format-time/format-relative.ts";
import { stripAssistantInternalScaffolding } from "@openclaw/shared/text/assistant-visible-text.js";
